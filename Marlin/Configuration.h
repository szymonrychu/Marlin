...
#define STRING_CONFIG_H_AUTHOR "Szymon Richert" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200,200,800,837}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          {500, 500, 200, 300}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2500, 2500, 10, 10000 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.35 //-0.65   // Z offset: -below +above  [the nozzle]
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    31        // LED driving pin on motherboard 4 => D4 (EXP2-5 on Printrboard) / 30 => PC7 (EXP3-13 on Rumba)
  #define NEOPIXEL_PIXELS 16       // Number of LEDs on strip
